 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://localhost:8080/zahtevcir}zahtev" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "zahtevi", namespace = "http://localhost:8080/zahtevcir")
public class Zahtevi {

    @XmlElement(namespace = "http://localhost:8080/zahtevcir")
