...
public class IzvestajService extends Service {
    ...
    public final static QName SERVICE = new QName("http://administracija/ws/resenje", "IzvestajService");
    public final static QName IzvestajPort = new QName("http://administracija/ws/resenje", "IzvestajPort");
    static {
